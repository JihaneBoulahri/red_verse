  ...
  methods: {
    ...
    async addToPlaylist(playlist) {
      ...
      try {
        ...
        console.log("Ajout de la musique:", musicObject);
        ...
        const response = await fetch(`http://localhost:3000/api/playlists/${playlist.id}`, {
          method: 'PATCH',
          headers: { 
    ...
    async createPlaylist() {
      ...
      try {
        ...
        // CORRECTION ICI : Utiliser la variable 'name' directement
        const newPlaylist = {
          id: Date.now(), 
          name: name, // Utiliser la variable 'name' locale
